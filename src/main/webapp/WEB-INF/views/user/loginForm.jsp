...
<div class="container">
	...
	<form action="/auth/loginProc" method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=7e8e3c714dac02cee56bdf18fa0fbc4c&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code">
